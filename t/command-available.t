...
#
my %available_perls = (
   'perl-5.27.4'      => 'https://www.cpan.org/src/5.0/perl-5.27.4.tar.gz',
   'perl-5.26.1'      => 'https://www.cpan.org/src/5.0/perl-5.26.1.tar.gz',
   'perl-5.24.3'      => 'https://www.cpan.org/src/5.0/perl-5.24.3.tar.gz',
   'perl-5.22.4'      => 'https://www.cpan.org/src/5.0/perl-5.22.4.tar.gz',
   'perl-5.20.3'      => 'https://www.cpan.org/src/5.0/perl-5.20.3.tar.gz',
   'perl-5.18.4'      => 'https://www.cpan.org/src/5.0/perl-5.18.4.tar.gz',
   'perl-5.16.3'      => 'https://www.cpan.org/src/5.0/perl-5.16.3.tar.gz',
   'perl-5.14.4'      => 'https://www.cpan.org/src/5.0/perl-5.14.4.tar.gz',
   'perl-5.12.5'      => 'https://www.cpan.org/src/5.0/perl-5.12.5.tar.gz',
   'perl-5.10.1'      => 'https://www.cpan.org/src/5.0/perl-5.10.1.tar.gz',
    'perl-5.8.9'      => 'https://www.cpan.org/src/5.0/perl-5.8.9.tar.gz',
    'perl-5.6.2'      => 'https://www.cpan.org/src/5.0/perl-5.6.2.tar.gz',
  'perl5.005_04'      => 'https://www.cpan.org/src/5.0/perl5.005_04.tar.gz',
  'perl5.004_05'      => 'https://www.cpan.org/src/5.0/perl5.004_05.tar.gz',
